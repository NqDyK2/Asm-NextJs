            ...
            <footer className={styles.footer}>
                <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                    ...
                    <div className="flex justify-center">
                        ...
                        <a href="https://github.com/NqDyK2/Asm-NextJs" className="text-gray-600 hover:text-white">
                ...
                {/* <div className="text-center p-6 bg-black">
                    ...
                    <a className="text-white font-semibold" href="https://github.com/NqDyK2/Asm-NextJs"> GitHub</a>
                </div> */}
            </footer>
