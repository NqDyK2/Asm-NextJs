    ...
    <>
      <div className="h-full w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between hidden sm:flex">
        <div>
          ...
          <ul className="mt-12">
            <Link href={"/admin"}>
              <li className="text-slate-50	 flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center py-3 px-8">
            ...
            <Link href={"/admin/films"}>
              <li className="text-slate-50	 flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Films</span>
                </div>
              </li>
            </Link>
            <li className="text-slate-50	 flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3">
        ...
        <div className="px-8 bg-indigo-800">
          <ul className="w-full flex items-center justify-between ">
            <li className=" cursor-pointer text-slate-50	 pt-5 pb-3">
