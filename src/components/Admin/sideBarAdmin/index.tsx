...
const NavAdmin = (props: Props) => {
  return (
    <>
      <div className="h-full w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between hidden sm:flex">
        <div>
          ...
          <ul className="mt-12">
            <li className=" text-white flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center py-3 px-8">
            ...
            <li className="text-white flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3">
              <div className="flex items-center">
            ...
            <li className="text-white text-whiteflex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3">
              <div className="flex items-center">
